...
const steps = [
  {
    ...
    icon: "Search",
    color: "#F5C518",
    description: "Перед надеванием проверьте каску на наличие трещин, сколов и деформаций. Осмотрите подтулейное устройство — оно должно быть целым и эластичным.",
    details: [
      "Проверьте корпус на трещины и сколы",
      "Осмотрите внутреннюю подвеску",
      "Убедитесь в исправности застёжек",
      "Проверьте дату изготовления (срок эксплуатации — не более 2 лет)",
    ],
    warning: "Повреждённая каска не защищает! Замените немедленно.",
    emoji: "🔍",
  },
  {
    id: 2,
    title: "Отрегулируйте размер",
    icon: "Settings2",
    color: "#FF6B35",
    description: "Настройте размер подтулейного устройства под размер вашей головы. Каска должна сидеть плотно, но без давления.",
    details: [
      "Найдите регулировочный механизм внутри каски",
      "Отрегулируйте обхват по периметру головы",
      "Настройте высоту посадки (зазор 30–50 мм от темени)",
      "Убедитесь, что подвеска не касается макушки",
    ],
    warning: "Зазор между головой и корпусом должен быть 30–50 мм.",
    emoji: "⚙️",
  },
  {
    id: 3,
    ...
    icon: "ArrowDown",
    color: "#4CAF50",
    description: "Возьмите каску двумя руками за боковые части и наденьте на голову строго горизонтально, козырьком вперёд.",
    details: [
      "Держите каску двумя руками за борта",
      "Наклоните голову немного вперёд",
      "Наденьте плавным движением сверху вниз",
      "Козырёк направлен строго вперёд",
    ],
    warning: "Запрещено надевать каску козырьком назад!",
    emoji: "⛑️",
  },
  {
    id: 4,
    title: "Застегните подбородочный ремень",
    icon: "Link",
    color: "#2196F3",
    description: "Закрепите подбородочный ремень для надёжной фиксации каски. Ремень должен плотно прилегать, но не сдавливать.",
    details: [
      "Пропустите ремень под подбородком",
      "Застегните пряжку",
      "Отрегулируйте длину — должен проходить один палец",
      "Проверьте симметричность крепления",
    ],
    warning: "Без застёгнутого ремня каска слетит при ударе.",
    emoji: "🔗",
  },
  {
    id: 5,
    title: "Проверьте посадку",
    icon: "CheckCircle",
    color: "#9C27B0",
    description: "Убедитесь в правильной посадке каски: она не должна качаться, соскальзывать или сдавливать голову.",
    details: [
      "Покачайте головой — каска не должна двигаться",
      "Попробуйте сдвинуть каску руками — она должна держаться",
      "Убедитесь в комфорте при движении",
      "Проверьте, что козырёк не закрывает обзор",
    ],
    warning: "Если каска болтается — отрегулируйте подвеску заново.",
    emoji: "✅",
  },
];

const facts = [
  { icon: "Shield", text: "Каска выдерживает удар 5 кг с высоты 1 метра" },
  { icon: "Clock", text: "Срок эксплуатации — не более 2 лет с даты выпуска" },
  { icon: "Thermometer", text: "Рабочий диапазон температур: от −10 до +50°C" },
  { icon: "Zap", text: "Электроизоляционные каски защищают до 440 В" },
];
          ...
          <div className={`flex-shrink-0 transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 bg-card border border-border rounded-2xl px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs text-muted-foreground">Обязательно к применению</div>
                  <div className="font-heading font-semibold text-foreground text-sm">ГОСТ Р 12.4.207</div>
                </div>
              </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1">
              ...
              <ul className="space-y-4">
                {[
                  "Козырёк смотрит строго вперёд",
                  "Каска не болтается на голове",
                  "Подбородочный ремень застёгнут",
                  "Зазор между теменем и корпусом 30–50 мм",
                ].map((item, i) => (
      ...
      <footer className="border-t border-border py-10">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-muted-foreground text-sm text-center">
            Инструкция разработана в соответствии с ГОСТ Р 12.4.207 и требованиями охраны труда
          </p>
        </div>
      </footer>
    </div>
